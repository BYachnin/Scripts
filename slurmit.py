...
def validate(args):
    ...
    try:
        if args.openmode is not None and args.openmode != 'append' and args.openmode != 'truncate':
    ...
    try:
        if args.usearray:
            ...
            if args.arraygen is None and args.array is None:
