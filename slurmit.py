...
def gen_varkey():
	...
	vars.append(('arraygen', None, str, None, False, 'other', "Specify bash code to generate a bash array to be used to populate the SLURM array.  In bash, an array can be generated within parentheses, and specific elements can be referenced with square brackets."))
